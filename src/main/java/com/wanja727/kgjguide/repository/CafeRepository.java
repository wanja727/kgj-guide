...
public interface CafeRepository extends JpaRepository<Cafe, String>, QuerydslPredicateExecutor<Cafe> { //CafeRepositoryCustom
    ...
    @Query("select new com.wanja727.kgjguide.dto.CafeDto(a.cafeId, a.cafeNm, a.brchNm, a.indsSclsNm, a.bldNm, a.rdnmAdr, distance(:currPoint, a.point, true), a.point, 0.0, 0.0, a.storeSize, a.floor, a.consentScoreAverage, a.wifiScoreAverage, a.comfortScoreAverage) "+ //astext(transform(a.point, 4326))
            "from Cafe a "+
