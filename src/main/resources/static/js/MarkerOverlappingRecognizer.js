...
var MarkerOverlappingRecognizer = function(opts) {
    this._options = $.extend({
        ...
        intersectNoticeTemplate: '<div style="border:solid 1px #333;background-color:#fff;padding:5px;width: max-content;"><em style="font-weight:bold;color:black;">{{count}}</em>개의 마커가 있습니다.</div>',
        intersectList: true,
